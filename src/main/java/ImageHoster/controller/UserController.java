...
public class UserController {
    ...
    public String registerUser(User user, Model model) {
        ...
        Pattern patternAlpha= Pattern.compile(regexAlpha);
        Pattern patternSpecialChar= Pattern.compile(regexSpecialChar);
        String password = user.getPassword();
        boolean isContainNumber = patternNumber.matcher(password).find();
        boolean isContainAlpha = patternAlpha.matcher(password).find();
        boolean isContainSpecial = patternSpecialChar.matcher(password).find();

        if(password != null &&  isContainAlpha && isContainNumber  && isContainSpecial){
